/**
 * Collective Node Class
 *
 *  This abstract class is the root type of all the JSON nodes that contain 
...
namespace IASLib
{
    class CJsonNode : public CObject
    {
        public:
            ...
            virtual CStringArray *findValuesAsText(CString fieldName, CStringArray *foundSoFar);
